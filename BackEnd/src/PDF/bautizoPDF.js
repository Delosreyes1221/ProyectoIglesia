...
function bautizoPDF() {
    const informacion = {
        ...
        nom_nombreB: 'Carlos Orozco Garcia',
        lugar_Nac: 'Reynosa, Tamaulipas',
        dia_nac: 4,
        mes_nac: "Agosto",
        anio_nac: 1998,
        nom_padre1: "Carlos Efren de los Reyes Bueno",
        nom_padre2: "Samantha Anareli de los Reyes Bueno",
        nom_padrino1: 'Judith Esmeralda Bueno Garcia',
        nom_padrino2: 'Efren de los Reyes Mireles',
        num_libro: 21,
        num_foja: 127,
        num_acta: 1258,
